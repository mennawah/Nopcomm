...
public class P03_HomePage {
  ...
  //  click on comparelist btn
    public WebElement clickonComparelist(){
       By HTCcompareListBtn = By.xpath("(//*[@class=\"button-2 add-to-compare-list-button\"])");
     return driver.findElement(HTCcompareListBtn);
